...
public class SerializedIPAddress implements Serializable {
	...
	public SerializedIPAddress(IPAddress ipAddress){
		this.ipID = ipAddress.getIpAddressID();
		this.ipValue = ipAddress.getValue();
		this.ownerClient = new SerializedClient(ipAddress.getClient());
	}	
